...
// making all the togglers false used for search functionality
          ...
          children: [
            Stack(
              children: [
                ...
                //Implementation of Search box of the rotating button at left
                // if the searchToggle is true show a searchbox (initially false)
                searchToggle
                    ? Padding(
                ...
                radiusSlider
                    ? Padding(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              //Back button when the map is clicked
                              IconButton(
                                  onPressed: () {
                          ...
                          back: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  height: 250.0,
                                  child: (isReviews && !isPhotos && !isMenu)
                                      ? ListView(
                                          children: [
                                            if (isReviews &&
