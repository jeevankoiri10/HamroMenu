...
import '../../user/user_crud.dart';

class UploadMenuDetails extends StatefulWidget {
  const UploadMenuDetails({super.key});

  @override
  State<UploadMenuDetails> createState() => _UploadMenuDetailsState();
}

class _UploadMenuDetailsState extends State<UploadMenuDetails> {
